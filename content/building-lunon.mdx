...
AI has made the traditional tech path feel obsolete. Coding agents are already doing work that used to require entire teams, and it is only accelerating. I stopped waiting for safety and started building. Now, I have a sense of direction I didn't know I was missing.
...
The prestige tied to tech jobs was fading, and the idea of relying on a company for stability felt outdated. If I stayed on that path, I would be placing my future in the hands of forces I could not control.
